...
require (
	...
	github.com/bnb-chain/versioned-state-database v0.0.0-20240919024445-9b2e3f9bd2ab
...
replace (
	...
	github.com/ethereum/go-ethereum v1.14.7 => github.com/bnb-chain/bsc v1.4.13-0.20240906060612-d4879836c05c
