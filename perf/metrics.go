...
var (
	...
	StateDBSmallStoragePutLatency  = metrics.NewRegisteredTimer("statedb/small/storage/put/latency", nil)
	StateDBLargeStoragePutLatency  = metrics.NewRegisteredTimer("statedb/large/storage/put/latency", nil)
	StateDBSingleStoragePutLatency = metrics.NewRegisteredTimer("statedb/single/storage/put/latency", nil)
	StateDBAccGetLatency           = metrics.NewRegisteredTimer("statedb/account/get/latency", nil)
	StateDBSmallStorageGetLatency  = metrics.NewRegisteredTimer("statedb/large/storage/get/latency", nil)
	StateDBLargeStorageGetLatency  = metrics.NewRegisteredTimer("statedb/small/storage/get/latency", nil)
